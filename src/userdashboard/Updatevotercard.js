...
import "../votercard/votercard.css"; // Make sure to create and link this CSS file
import data from '../votercard/data.js';
...
function Updatevotercard() {
 ...
 const [epicinputdisable,setEpicInputDisable]=useState(false)
  ...
  useEffect(() => {
    ...
    try{
    if (votercardData.epic_no.length === 10 && epicinputdisable==false) {
 ...
 async function veryfyClick(e) {
  ...
  await  axios.post("/api/verifyepic_no", {epic_no:votercardData.epic_no}, {
     ...
     votercardData.aadhar=res.data.aadhar;
     setInputdisable(false)
     setVerifyDisable(true)
     setEpicInputDisable(true)
    ...
    <Userheader></Userheader>
      <form  enctype="multipart/form-data" >
        <div className="form-6">
          ...
          <h2 className="section-title">A. Voter Id</h2>
          <div className="voter-id">
            <label htmlFor="name">voter Epic No:</label>
            <input
              onChange={handlechange}
              disabled={epicinputdisable}
              id="epic-input"
              type="text"
              required
              value={votercardData.epic_no}
              name="epic_no"
            />
               <button className="custom-verify-button verify" disabled={verifydisable} onClick={veryfyClick}>
                    Verify
                </button>
            </div>
          ...
          <select  disabled={inputdisable} onChange={handlechange} name="district"  id="District" required>
          <option value={null}>--Select--</option>
          ...
          <h2 className="section-title">C. Personal Details</h2>
          ...
          <hr />
          <h2 className="section-title">D.Aadhar number</h2>
          <div className="dob">
          ...
          <hr />
          <h2 className="section-title">E. Date Of Birth</h2>
          <div className="dob">
          ...
          <h2 className="section-title">F. Present Address Details</h2>
...
export default Updatevotercard